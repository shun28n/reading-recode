...
import { UPDATE_CURREMT, UPDATE_BOOK} from '@/mutation_types'
...
export default {
    ...
    mounted(){
        // 選択中の書籍でストア内の情報を検索
        let book = this.getBookById(this.book.id)
    ...
    methods: {
        // アクションとメソッドとを紐付け
        ...mapActions([UPDATE_BOOK, UPDATE_CURREMT]),
        // [登録]ボタンでデータを登録
        onsubmit(){
            // 入力値の検証を実行
